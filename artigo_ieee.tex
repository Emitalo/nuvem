...
Algoritmos de criptografia                                                                   & Security                                                                                                  & \multirow{9}{*}{Paper 6 [19]}                                                          \\ \cline{1-2}
Apreensibilidade do serviço                                                                  & Usability                                                                                                &                                                                                         \\ \cline{1-2}
Controle de acesso                                                                           & Security                                                                                                  &                                                                                         \\ \cline{1-2}
Data Control                                                                            & Data Control                                                                                          &                                                                                         \\ \cline{1-2}
Defeitos por milhão (DPM)                                                                    & -                                                                                                          &                                                                                         \\ \cline{1-2}
Facilidade de uso                                                                            & Usability                                                                                                &                                                                                         \\ \cline{1-2}
Instalabilidade do IaaS                                                                      & Usability                                                                                                &                                                                                         \\ \cline{1-2}
Data Privacy                                                                        & Security                                                                                                  &                                                                                         \\ \cline{1-2}
\begin{tabular}[c]{@{}l@{}}Tempo médio entre \\ falhas (MTBF)\end{tabular}                   & Reliability                                                                                             &                                                                                         \\ \hline
Políticas de controle de acesso                                                              & \begin{tabular}[c]{@{}l@{}}Security/ \\ Privacy\end{tabular}                                          & Paper 5 [18]                                                                           \\ \hline
Custo de VM                                                                                  & Cost                                                                                                      & \begin{tabular}[c]{@{}l@{}}Paper 5 [18] \\ Paper 4 [1]\end{tabular}                  \\ \hline
\begin{tabular}[c]{@{}l@{}}Armazenamento \\ (memória permanente, ex.HD)\end{tabular}         & -                                                                                                          & \multirow{16}{*}{Paper 3 [3]}                                                          \\ \cline{1-2}
...
\begin{tabular}[c]{@{}l@{}}Memória (RAM requerida \\ para instância)\end{tabular}            & \begin{tabular}[c]{@{}l@{}}Reliability/ \\ Sustainability\end{tabular}                        & \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Paper 3 [3] \\ Paper 4 [1]\end{tabular}}  \\ \cline{1-2}
Tempo de resposta (aplicação)                                                                & Performance                                                                                                &                                                                                         \\ \hline
Disponibilidade                                                                              & -                                                                                                          & \begin{tabular}[c]{@{}l@{}}Paper 3 [3] \\ Paper 4 [1] \\ Paper 6 [19]\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}Atraso de transferência \\ TCP/UDP/IP\end{tabular}                & \begin{tabular}[c]{@{}l@{}}Performance / \\ Communication\end{tabular}                          & \multirow{2}{*}{Paper 2 [4]}                                                           \\ \cline{1-2}
\begin{tabular}[c]{@{}l@{}}Velocidade de transferência \\ bit/byte TCP/UDP/IP\end{tabular}   & \begin{tabular}[c]{@{}l@{}}Performance / \\ Communication\end{tabular} &                                                                                         \\ \hline
Confidencialidade                                                                            & \begin{tabular}[c]{@{}l@{}}Security /\\ Authentication\end{tabular}                                         & \multirow{9}{*}{Paper 1 [5]}                                                           \\ \cline{1-2}
Efetividade                                                                                  & \begin{tabular}[c]{@{}l@{}}Security / \\ Authentication\end{tabular}                                        &                                                                                         \\ \cline{1-2}
Habilidade de auditoria                                                                      & \begin{tabular}[c]{@{}l@{}}Security / \\ Data Security\end{tabular}                                 &                                                                                         \\ \cline{1-2}
Modularidade                                                                                 & -                                                                                                          &                                                                                         \\ \cline{1-2}
Sensibilidade                                                                                & \begin{tabular}[c]{@{}l@{}}Security / \\ Authentication\end{tabular}                                        &                                                                                         \\ \cline{1-2}
Tempo de boot                                                                                & \begin{tabular}[c]{@{}l@{}}Economy / \\ Elasticity\end{tabular}                                         &                                                                                         \\ \cline{1-2}
Tempo de computação                                                                          & \begin{tabular}[c]{@{}l@{}}Performance \end{tabular}                                             &                                                                                         \\ \cline{1-2}
Utilização de recursos                                                                       & Eficiency                                                                                                 &                                                                                         \\ \cline{1-2}
...
\begin{tabular}{|l|l|l|}
\hline
Carga de CPU                                                                                 & \begin{tabular}[c]{@{}l@{}}Performance /\\ Computação\end{tabular}                                         & \multirow{21}{*}{\begin{tabular}[c]{@{}l@{}}Paper 1 [5] \\ Paper 2 [4]\end{tabular}} \\ \cline{1-2}
\begin{tabular}[c]{@{}l@{}}Custo de recursos de \\ componentes\end{tabular}                  & Economy / Cost                                                                                           &                                                                                         \\ \cline{1-2}
Custo por FLOP                                                                               & Economy / Cost                                                                                           &                                                                                         \\ \cline{1-2}
Custo por tempo fixo                                                                         & Economy / Cost                                                                                           &                                                                                         \\ \cline{1-2}
Custo total                                                                                  & Economy / Cost                                                                                           &                                                                                         \\ \cline{1-2}
Eficiência da Instância                                                                      & \begin{tabular}[c]{@{}l@{}}Performance / \\ Computation\end{tabular}                                        &                                                                                         \\ \cline{1-2}
Frequência de perda de pacotes                                                               & \begin{tabular}[c]{@{}l@{}}Performance / \\ Communication\end{tabular}                                       &                                                                                         \\ \cline{1-2}
\begin{tabular}[c]{@{}l@{}}Latência de comunicação \\ sobre SSL\end{tabular}                 & \begin{tabular}[c]{@{}l@{}}Security / \\ Data Security\end{tabular}                                 &                                                                                         \\ \cline{1-2}
Razão Preço/Performance                                                                      & Economy / Cost                                                                                           &                                                                                         \\ \cline{1-2}
SSL aplicável?                                                                               & \begin{tabular}[c]{@{}l@{}}Security / \\ Data Security\end{tabular}                                 &                                                                                         \\ \cline{1-2}
Taxa de atualização de RAM                                                                   & \begin{tabular}[c]{@{}l@{}}Performance / \\ Memory\end{tabular}                                           &                                                                                         \\ \cline{1-2}
Taxa de erros de conexão                                                                     & \begin{tabular}[c]{@{}l@{}}Performance / \\ Communication\end{tabular}                                       &                                                                                         \\ \cline{1-2}
\begin{tabular}[c]{@{}l@{}}Taxa de FLOPs (Float Point \\ Operations Per Second)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Performance / \\ Computation\end{tabular}                                        &                                                                                         \\ \cline{1-2}
Tempo de comunicação                                                                         & Performance                                                                                        &                                                                                         \\ \cline{1-2}
Tempo de deleção                                                                             & \begin{tabular}[c]{@{}l@{}}Economy / \\ Elasticity\end{tabular}                                          &                                                                                         \\ \cline{1-2}
Tempo de implantação                                                                         & \begin{tabular}[c]{@{}l@{}}Economy / \\ Elasticity\end{tabular}                                         &                                                                                         \\ \cline{1-2}
Tempo de suspensão                                                                           & \begin{tabular}[c]{@{}l@{}}Economy / \\ Elasticity\end{tabular}                                         &                                                                                         \\ \cline{1-2}
Tempo total de aquisição                                                                     & \begin{tabular}[c]{@{}l@{}}Economy / \\ Elasticity\end{tabular}                                         &                                                                                         \\ \cline{1-2}
\begin{tabular}[c]{@{}l@{}}Usuários suportados em um \\ orçamento fixo\end{tabular}          & Economy / Cost                                                                                           &                                                                                         \\ \cline{1-2}
Interoperabilidade                                                                           & -                                                                                                          &                                                                                         \\ \cline{1-2}
Tempo de resposta (memória)                                                                  & \begin{tabular}[c]{@{}l@{}}Performance / \\ Memory\end{tabular}                                           &                                                                                         \\ \hline
Acurácia                                                                                     & -                                                                                                          & \multirow{5}{*}{Paper 4 [1]}                                                           \\ \cline{1-2}
Adequação                                                                                    & -                                                                                                          &                                                                                         \\ \cline{1-2}
Reliability                                                                               & -                                                                                                          &                                                                                         \\ \cline{1-2}
...
\begin{tabular}{@{}lll@{}}
\toprule
\multicolumn{3}{c}{\textbf{Dinâmicas}}                                                                  \\ \midrule
\multicolumn{1}{c}{\textbf{Categoria}} & \multicolumn{1}{c}{\textbf{Métrica}}                                                  & \multicolumn{1}{c}{\textbf{Há no Openstack?}} \\
...
% 	  \caption{Lista de métricas coletadas pelo \textit{Ceilometer}.}
% 	  \label{tab:meters_list}
...
\begin{tabular}{@{}lcccc@{}}
\toprule
\multicolumn{1}{c}{\textbf{Métrica}}                                     & \textbf{Max} & \textbf{Min} & \textbf{Media} & \textbf{Unidade} \\ \midrule
cpu\_util                                                                & 16.11        & 0            & 7.9            & \%               \\
memory                                                                   & 512          & 512          & 512            & MB               \\
memory.usage                                                             & -            & -            & -              & MB               \\
disk.root.size                                                           & 1            & 1            & 1              & GB               \\
vcpus                                                                    & 1            & 1            & 1              & nº vCPUs         \\
\begin{tabular}[c]{@{}l@{}}network.incoming\\ .packets\end{tabular}      & 19           & 8            & 11.75          & pacotes          \\
\begin{tabular}[c]{@{}l@{}}network.incoming\\ .packets.rate\end{tabular} & 0.0016       & 0.00011      & 0.00011        & pacotes/s        \\
\begin{tabular}[c]{@{}l@{}}network.outgoing\\ .packets\end{tabular}      & 9            & 9            & 9              & pacotes          \\
\begin{tabular}[c]{@{}l@{}}network.outgoing\\ .packets.rate\end{tabular} & 0            & 0            & 0              & pacotes/s        \\
disk.read.requests                                                       & 1122         & 877          & 1032.77        & requisições      \\
\begin{tabular}[c]{@{}l@{}}disk.read\\ .requests.rate\end{tabular}       & 0.23         & 0            & 0.015          & requisições/s    \\
disk.write.requests                                                      & 134          & 55           & 111.9          & requisições      \\
\begin{tabular}[c]{@{}l@{}}disk.write\\ .requests.rate\end{tabular}      & 0.091        & 0            & 0.001          & requisições/s    \\
