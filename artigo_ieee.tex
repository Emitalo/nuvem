...
OpenStack fornecia 41\% das métricas de QoS propostas na literatura.
\end{abstract}
...
35 foram avaliadas no Openstack. Na avaliação foi possível perceber que o Openstack provia 41\% das métricas exatas e além disso
